...
export const PersonasApi = {
  async getAll(): Promise<Persona[]> {
    const response = await apiCall<ApiEnvelope<Persona[]> | Persona[]>('/persona/persona-usuario?numeroIdentificacion=');
  ...
  async updatePersona(idPersona: number, payload: UpdatePersonaPayload): Promise<void> {
  ...
  async getRoles(): Promise<Rol[]> {
    const response = await apiCall<ApiEnvelope<Rol[]> | { data: Rol[] }>('/rol');
  ...
  async updateUsuario(idUsuario: number, payload: UpdateUsuarioPayload): Promise<void> {
